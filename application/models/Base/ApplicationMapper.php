...
/**
 * Application_Model_Base_ApplicationMapperクラス
 *
 * 自動生成クラス
 *
 * @category Zend
 ...
 * @subpackage Base
 */
abstract class Application_Model_Base_ApplicationMapper extends Application_Model_BaseMapper
{

    /**
     * @var Zend_Db_Table Zend_Db_Table
     */
    protected $_modelName = 'Application_Model_Application';

    /**
     * TableDataを返す。
     *
     * @return Application_Model_DbTable_Application Application_Model_DbTable_Applicationのオブジェクト
     */
    public function getDbTable()
    {
        if (null === $this->_dbTable) {
            $this->setDbTable('Application_Model_DbTable_Application');
        }
     ...
     * モデルオブジェクトのデータを返す。
     *
     * @return array Application_Model_Applicationのオブジェクトから取り出したデータ
     */
    protected function _dataSet(Application_Model_Application $application)
    {
        return array(
        ...
        'application_secret' => $application->getApplicationSecret(),
        'created_date' => $application->getCreatedDate(),
        'updated_date' => $application->getUpdatedDate(),
        'deleted_date' => $application->getDeletedDate(),
        );
    }
     ...
     *
     * @param Application_Model_Application $application Application_Model_Applicationのオブジェクト
     * @return mixed The primary key of the row inserted.
     */
    public function insertWithDefaultValues(Application_Model_Application $application)
    {
        $data = $this->_dataSet($application);
     ...
     * @return Application_Model_Base_ApplicationMapper Application_Model_Base_ApplicationMapperのオブジェクト
     */
     ...
     * @return array Application_Model_Applicationのオブジェクト配列
     */
     ...
     * @return mixed The primary key of the row inserted.
     */
    public function insert(Application_Model_Application $application)
    {
        return parent::insert($application);
    }
     ...
     * 結果が1件の場合は、Application_Model_Applicationのオブジェクトを返す。<br>
     * 結果が複数件の場合は、Application_Model_Applicationの配列を返す。<br>
     * <br>
     * 使用方法<br>
     * <pre>
     * // 単一の行を探す。
     ...
     * @return Application_Model_Application|array メソッドの説明を参照
     ...
     * @return mixed The primary key of the row inserted.
     */
    public function replace(Application_Model_Application $application)
    {
        return parent::replace($application);
    }
