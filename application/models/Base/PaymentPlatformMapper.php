...
/**
 * Application_Model_Base_PaymentPlatformMapperクラス
 *
 * 自動生成クラス
 *
 * @category Zend
 ...
 * @subpackage Base
 */
abstract class Application_Model_Base_PaymentPlatformMapper extends Application_Model_BaseMapper
{

    /**
     * @var Zend_Db_Table Zend_Db_Table
     */
    protected $_modelName = 'Application_Model_PaymentPlatform';

    /**
     * TableDataを返す。
     *
     * @return Application_Model_DbTable_PaymentPlatform Application_Model_DbTable_PaymentPlatformのオブジェクト
     */
    public function getDbTable()
    {
        if (null === $this->_dbTable) {
            $this->setDbTable('Application_Model_DbTable_PaymentPlatform');
        }
     ...
     * モデルオブジェクトのデータを返す。
     *
     * @return array Application_Model_PaymentPlatformのオブジェクトから取り出したデータ
     */
    protected function _dataSet(Application_Model_PaymentPlatform $paymentPlatform)
    {
        return array(
        'payment_platform_id' => $paymentPlatform->getPaymentPlatformId(),
        'platform_name' => $paymentPlatform->getPlatformName(),
        'platform_domain' => $paymentPlatform->getPlatformDomain(),
        'created_date' => $paymentPlatform->getCreatedDate(),
        'updated_date' => $paymentPlatform->getUpdatedDate(),
        'deleted_date' => $paymentPlatform->getDeletedDate(),
        );
    }
     ...
     *
     * @param Application_Model_PaymentPlatform $paymentPlatform Application_Model_PaymentPlatformのオブジェクト
     * @return mixed The primary key of the row inserted.
     */
    public function insertWithDefaultValues(Application_Model_PaymentPlatform $paymentPlatform)
    {
        $data = $this->_dataSet($paymentPlatform);
     ...
     * @return Application_Model_Base_PaymentPlatformMapper Application_Model_Base_PaymentPlatformMapperのオブジェクト
     */
     ...
     * @return array Application_Model_PaymentPlatformのオブジェクト配列
     */
     ...
     * @return mixed The primary key of the row inserted.
     */
    public function insert(Application_Model_PaymentPlatform $paymentPlatform)
    {
        return parent::insert($paymentPlatform);
    }
     ...
     * 結果が1件の場合は、Application_Model_PaymentPlatformのオブジェクトを返す。<br>
     * 結果が複数件の場合は、Application_Model_PaymentPlatformの配列を返す。<br>
     * <br>
     * 使用方法<br>
     * <pre>
     * // 単一の行を探す。
     ...
     * @return Application_Model_PaymentPlatform|array メソッドの説明を参照
     ...
     * @return mixed The primary key of the row inserted.
     */
    public function replace(Application_Model_PaymentPlatform $paymentPlatform)
    {
        return parent::replace($paymentPlatform);
    }
