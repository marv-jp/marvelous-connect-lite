...
/**
 * Application_Model_Base_PaymentDeviceMapperクラス
 *
 * 自動生成クラス
 *
 * @category Zend
 ...
 * @subpackage Base
 */
abstract class Application_Model_Base_PaymentDeviceMapper extends Application_Model_BaseMapper
{

    /**
     * @var Zend_Db_Table Zend_Db_Table
     */
    protected $_modelName = 'Application_Model_PaymentDevice';

    /**
     * TableDataを返す。
     *
     * @return Application_Model_DbTable_PaymentDevice Application_Model_DbTable_PaymentDeviceのオブジェクト
     */
    public function getDbTable()
    {
        if (null === $this->_dbTable) {
            $this->setDbTable('Application_Model_DbTable_PaymentDevice');
        }
     ...
     * モデルオブジェクトのデータを返す。
     *
     * @return array Application_Model_PaymentDeviceのオブジェクトから取り出したデータ
     */
    protected function _dataSet(Application_Model_PaymentDevice $paymentDevice)
    {
        return array(
        'payment_device_id' => $paymentDevice->getPaymentDeviceId(),
        'device_name' => $paymentDevice->getDeviceName(),
        'created_date' => $paymentDevice->getCreatedDate(),
        'updated_date' => $paymentDevice->getUpdatedDate(),
        'deleted_date' => $paymentDevice->getDeletedDate(),
        );
    }
     ...
     *
     * @param Application_Model_PaymentDevice $paymentDevice Application_Model_PaymentDeviceのオブジェクト
     * @return mixed The primary key of the row inserted.
     */
    public function insertWithDefaultValues(Application_Model_PaymentDevice $paymentDevice)
    {
        $data = $this->_dataSet($paymentDevice);
     ...
     * @return Application_Model_Base_PaymentDeviceMapper Application_Model_Base_PaymentDeviceMapperのオブジェクト
     */
     ...
     * @return array Application_Model_PaymentDeviceのオブジェクト配列
     */
     ...
     * @return mixed The primary key of the row inserted.
     */
    public function insert(Application_Model_PaymentDevice $paymentDevice)
    {
        return parent::insert($paymentDevice);
    }
     ...
     * 結果が1件の場合は、Application_Model_PaymentDeviceのオブジェクトを返す。<br>
     * 結果が複数件の場合は、Application_Model_PaymentDeviceの配列を返す。<br>
     * <br>
     * 使用方法<br>
     * <pre>
     * // 単一の行を探す。
     ...
     * @return Application_Model_PaymentDevice|array メソッドの説明を参照
     ...
     * @return mixed The primary key of the row inserted.
     */
    public function replace(Application_Model_PaymentDevice $paymentDevice)
    {
        return parent::replace($paymentDevice);
    }
