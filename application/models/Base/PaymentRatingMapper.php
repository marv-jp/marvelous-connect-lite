...
/**
 * Application_Model_Base_PaymentRatingMapperクラス
 *
 * 自動生成クラス
 *
 * @category Zend
 ...
 * @subpackage Base
 */
abstract class Application_Model_Base_PaymentRatingMapper extends Application_Model_BaseMapper
{

    /**
     * @var Zend_Db_Table Zend_Db_Table
     */
    protected $_modelName = 'Application_Model_PaymentRating';

    /**
     * TableDataを返す。
     *
     * @return Application_Model_DbTable_PaymentRating Application_Model_DbTable_PaymentRatingのオブジェクト
     */
    public function getDbTable()
    {
        if (null === $this->_dbTable) {
            $this->setDbTable('Application_Model_DbTable_PaymentRating');
        }
     ...
     * モデルオブジェクトのデータを返す。
     *
     * @return array Application_Model_PaymentRatingのオブジェクトから取り出したデータ
     */
    protected function _dataSet(Application_Model_PaymentRating $paymentRating)
    {
        return array(
        'payment_rating_id' => $paymentRating->getPaymentRatingId(),
        'rating_name' => $paymentRating->getRatingName(),
        'created_date' => $paymentRating->getCreatedDate(),
        'updated_date' => $paymentRating->getUpdatedDate(),
        'deleted_date' => $paymentRating->getDeletedDate(),
        );
    }
     ...
     *
     * @param Application_Model_PaymentRating $paymentRating Application_Model_PaymentRatingのオブジェクト
     * @return mixed The primary key of the row inserted.
     */
    public function insertWithDefaultValues(Application_Model_PaymentRating $paymentRating)
    {
        $data = $this->_dataSet($paymentRating);
     ...
     * @return Application_Model_Base_PaymentRatingMapper Application_Model_Base_PaymentRatingMapperのオブジェクト
     */
     ...
     * @return array Application_Model_PaymentRatingのオブジェクト配列
     */
     ...
     * @return mixed The primary key of the row inserted.
     */
    public function insert(Application_Model_PaymentRating $paymentRating)
    {
        return parent::insert($paymentRating);
    }
     ...
     * 結果が1件の場合は、Application_Model_PaymentRatingのオブジェクトを返す。<br>
     * 結果が複数件の場合は、Application_Model_PaymentRatingの配列を返す。<br>
     * <br>
     * 使用方法<br>
     * <pre>
     * // 単一の行を探す。
     ...
     * @return Application_Model_PaymentRating|array メソッドの説明を参照
     ...
     * @return mixed The primary key of the row inserted.
     */
    public function replace(Application_Model_PaymentRating $paymentRating)
    {
        return parent::replace($paymentRating);
    }
