 ...
 * @subpackage Base
 */
class Application_Model_Base_ApplicationUserPaymentItemId
{

    const CLASS_NAME = 'Application_Model_Base_ApplicationUserPaymentItemId';
     ...
     *
     * @param mixed モデルデータ
     * @return Application_Model_Base_ApplicationUserPaymentItemId このクラスのオブジェクト
     */
     ...
     * @return Application_Model_Base_ApplicationUserPaymentItemId Application_Model_Base_ApplicationUserPaymentItemIdのオブジェクト
     */
