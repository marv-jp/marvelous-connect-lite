...
/**
 * Application_Model_Base_UserMapperクラス
 *
 * 自動生成クラス
 *
 * @category Zend
 ...
 * @subpackage Base
 */
abstract class Application_Model_Base_UserMapper extends Application_Model_BaseMapper
{

    /**
     * @var Zend_Db_Table Zend_Db_Table
     */
    protected $_modelName = 'Application_Model_User';

    /**
     * TableDataを返す。
     *
     * @return Application_Model_DbTable_User Application_Model_DbTable_Userのオブジェクト
     */
     ...
     * モデルオブジェクトのデータを返す。
     *
     * @return array Application_Model_Userのオブジェクトから取り出したデータ
     */
    protected function _dataSet(Application_Model_User $user)
    {
        return array(
     ...
     *
     * @param Application_Model_User $user Application_Model_Userのオブジェクト
     * @return mixed The primary key of the row inserted.
     */
    public function insertWithDefaultValues(Application_Model_User $user)
    {
        $data = $this->_dataSet($user);
     ...
     * @return Application_Model_Base_UserMapper Application_Model_Base_UserMapperのオブジェクト
     */
     ...
     * @return array Application_Model_Userのオブジェクト配列
     */
     ...
     * 結果が1件の場合は、Application_Model_Userのオブジェクトを返す。<br>
     * 結果が複数件の場合は、Application_Model_Userの配列を返す。<br>
     * <br>
     * 使用方法<br>
     * <pre>
     * // 単一の行を探す。
     ...
     * @return Application_Model_User|array メソッドの説明を参照
     ...
     * @return mixed The primary key of the row inserted.
     */
    public function replace(Application_Model_User $user)
    {
        return parent::replace($user);
    }
