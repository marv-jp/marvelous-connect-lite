 ...
 * @subpackage Base
 */
class Application_Model_Base_ApplicationUserTargetCurrencyPaymentItem
{

    const CLASS_NAME = 'Application_Model_Base_ApplicationUserTargetCurrencyPaymentItem';
    ...
    /**
     * @var integer 価格 PK:int_unsigned
     */
     ...
     *
     * @param mixed モデルデータ
     * @return Application_Model_Base_ApplicationUserTargetCurrencyPaymentItem このクラスのオブジェクト
     */
     ...
     * @return Application_Model_Base_ApplicationUserTargetCurrencyPaymentItem Application_Model_Base_ApplicationUserTargetCurrencyPaymentItemのオブジェクト
     */
