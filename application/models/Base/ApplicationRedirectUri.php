 ...
 * @subpackage Base
 */
class Application_Model_Base_ApplicationRedirectUri
{

    const CLASS_NAME = 'Application_Model_Base_ApplicationRedirectUri';
    ...
    /**
     * @var string リダイレクトURI PK:varchar(255)
     */
     ...
     *
     * @param mixed モデルデータ
     * @return Application_Model_Base_ApplicationRedirectUri このクラスのオブジェクト
     */
     ...
     * @return Application_Model_Base_ApplicationRedirectUri Application_Model_Base_ApplicationRedirectUriのオブジェクト
     */
    ...
    /**
     * redirectUriプロパティーを設定する。
     *
     * @param string $redirectUri redirectUriの値
     * @return Application_Model_Base_ApplicationRedirectUri Application_Model_Base_ApplicationRedirectUriのオブジェクト
     */
    ...
    /**
     * redirectUriプロパティーを返す。
     *
     * @return string redirectUriの値
     */
    ...
    public function toArray()
    {
        ...
        $memberArray['redirectUri'] = $this->getRedirectUri();
