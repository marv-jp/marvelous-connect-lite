...
/**
 * Application_Model_Base_DeveloperMapperクラス
 *
 * 自動生成クラス
 *
 * @category Zend
 ...
 * @subpackage Base
 */
abstract class Application_Model_Base_DeveloperMapper extends Application_Model_BaseMapper
{

    /**
     * @var Zend_Db_Table Zend_Db_Table
     */
    protected $_modelName = 'Application_Model_Developer';

    /**
     * TableDataを返す。
     *
     * @return Application_Model_DbTable_Developer Application_Model_DbTable_Developerのオブジェクト
     */
    public function getDbTable()
    {
        if (null === $this->_dbTable) {
            $this->setDbTable('Application_Model_DbTable_Developer');
        }
     ...
     * モデルオブジェクトのデータを返す。
     *
     * @return array Application_Model_Developerのオブジェクトから取り出したデータ
     */
    protected function _dataSet(Application_Model_Developer $developer)
    {
        return array(
        'developer_id' => $developer->getDeveloperId(),
        'developer_name' => $developer->getDeveloperName(),
        'created_date' => $developer->getCreatedDate(),
        'updated_date' => $developer->getUpdatedDate(),
        'deleted_date' => $developer->getDeletedDate(),
        );
    }
     ...
     *
     * @param Application_Model_Developer $developer Application_Model_Developerのオブジェクト
     * @return mixed The primary key of the row inserted.
     */
    public function insertWithDefaultValues(Application_Model_Developer $developer)
    {
        $data = $this->_dataSet($developer);
     ...
     * @return Application_Model_Base_DeveloperMapper Application_Model_Base_DeveloperMapperのオブジェクト
     */
     ...
     * @return array Application_Model_Developerのオブジェクト配列
     */
     ...
     * @return mixed The primary key of the row inserted.
     */
    public function insert(Application_Model_Developer $developer)
    {
        return parent::insert($developer);
    }
     ...
     * 結果が1件の場合は、Application_Model_Developerのオブジェクトを返す。<br>
     * 結果が複数件の場合は、Application_Model_Developerの配列を返す。<br>
     * <br>
     * 使用方法<br>
     * <pre>
     * // 単一の行を探す。
     ...
     * @return Application_Model_Developer|array メソッドの説明を参照
     ...
     * @return mixed The primary key of the row inserted.
     */
    public function replace(Application_Model_Developer $developer)
    {
        return parent::replace($developer);
    }
