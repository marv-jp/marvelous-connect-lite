 ...
 * @subpackage Base
 */
class Application_Model_Base_ApplicationUserPaymentId
{

    const CLASS_NAME = 'Application_Model_Base_ApplicationUserPaymentId';
     ...
     *
     * @param mixed モデルデータ
     * @return Application_Model_Base_ApplicationUserPaymentId このクラスのオブジェクト
     */
     ...
     * @return Application_Model_Base_ApplicationUserPaymentId Application_Model_Base_ApplicationUserPaymentIdのオブジェクト
     */
