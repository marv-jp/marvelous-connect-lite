 ...
 * @subpackage Base
 */
class Application_Model_Base_Developer
{

    const CLASS_NAME = 'Application_Model_Base_Developer';

    /**
     * @var string デベロッパID PK:varchar(255)
     */
    protected $_developerId = null;

    /**
     * @var string デベロッパ名 varchar(255)
     */
    protected $_developerName = null;
     ...
     *
     * @param mixed モデルデータ
     * @return Application_Model_Base_Developer このクラスのオブジェクト
     */
     ...
     * @return Application_Model_Base_Developer Application_Model_Base_Developerのオブジェクト
     */
    ...
    /**
     * developerNameプロパティーを設定する。
     *
     * @param string $developerName developerNameの値
     * @return Application_Model_Base_Developer Application_Model_Base_Developerのオブジェクト
     */
    ...
    /**
     * developerNameプロパティーを返す。
     *
     * @return string developerNameの値
     */
    ...
    public function toArray()
    {
        ...
        $memberArray['developerName'] = $this->getDeveloperName();
