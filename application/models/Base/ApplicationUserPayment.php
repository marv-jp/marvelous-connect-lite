 ...
 * @subpackage Base
 */
class Application_Model_Base_ApplicationUserPayment
{

    const CLASS_NAME = 'Application_Model_Base_ApplicationUserPayment';
    ...
    /**
     * @var string ペイメントプラットフォームユーザID varchar(255)
     */
    protected $_paymentPlatformUserId = null;
     ...
     *
     * @param mixed モデルデータ
     * @return Application_Model_Base_ApplicationUserPayment このクラスのオブジェクト
     */
     ...
     * @return Application_Model_Base_ApplicationUserPayment Application_Model_Base_ApplicationUserPaymentのオブジェクト
     */
    ...
    /**
     * paymentPlatformUserIdプロパティーを設定する。
     *
     * @param string $paymentPlatformUserId paymentPlatformUserIdの値
     * @return Application_Model_Base_ApplicationUserPayment Application_Model_Base_ApplicationUserPaymentのオブジェクト
     */
    public function setPaymentPlatformUserId($paymentPlatformUserId)
    {
        $this->_paymentPlatformUserId = $paymentPlatformUserId; 
        return $this;
    }

    /**
     * paymentPlatformUserIdプロパティーを返す。
     *
     * @return string paymentPlatformUserIdの値
     */
    public function getPaymentPlatformUserId()
    {
        return $this->_paymentPlatformUserId;
    }
    ...
    public function toArray()
    {
        ...
        $memberArray['paymentPlatformUserId'] = $this->getPaymentPlatformUserId();
