...
/**
 * Application_Model_Base_CommonConstantMapperクラス
 *
 * 自動生成クラス
 *
 * @category Zend
 ...
 * @subpackage Base
 */
abstract class Application_Model_Base_CommonConstantMapper extends Application_Model_BaseMapper
{

    /**
     * @var Zend_Db_Table Zend_Db_Table
     */
    protected $_modelName = 'Application_Model_CommonConstant';

    /**
     * TableDataを返す。
     *
     * @return Application_Model_DbTable_CommonConstant Application_Model_DbTable_CommonConstantのオブジェクト
     */
    public function getDbTable()
    {
        if (null === $this->_dbTable) {
            $this->setDbTable('Application_Model_DbTable_CommonConstant');
        }
     ...
     * モデルオブジェクトのデータを返す。
     *
     * @return array Application_Model_CommonConstantのオブジェクトから取り出したデータ
     */
    protected function _dataSet(Application_Model_CommonConstant $commonConstant)
    {
        return array(
        'name' => $commonConstant->getName(),
        'value' => $commonConstant->getValue(),
        'created_date' => $commonConstant->getCreatedDate(),
        'updated_date' => $commonConstant->getUpdatedDate(),
        'deleted_date' => $commonConstant->getDeletedDate(),
        );
    }
     ...
     *
     * @param Application_Model_CommonConstant $commonConstant Application_Model_CommonConstantのオブジェクト
     * @return mixed The primary key of the row inserted.
     */
    public function insertWithDefaultValues(Application_Model_CommonConstant $commonConstant)
    {
        $data = $this->_dataSet($commonConstant);
     ...
     * @return Application_Model_Base_CommonConstantMapper Application_Model_Base_CommonConstantMapperのオブジェクト
     */
     ...
     * @return array Application_Model_CommonConstantのオブジェクト配列
     */
     ...
     * @return mixed The primary key of the row inserted.
     */
    public function insert(Application_Model_CommonConstant $commonConstant)
    {
        return parent::insert($commonConstant);
    }
     ...
     * 結果が1件の場合は、Application_Model_CommonConstantのオブジェクトを返す。<br>
     * 結果が複数件の場合は、Application_Model_CommonConstantの配列を返す。<br>
     * <br>
     * 使用方法<br>
     * <pre>
     * // 単一の行を探す。
     ...
     * @return Application_Model_CommonConstant|array メソッドの説明を参照
     ...
     * @return mixed The primary key of the row inserted.
     */
    public function replace(Application_Model_CommonConstant $commonConstant)
    {
        return parent::replace($commonConstant);
    }
